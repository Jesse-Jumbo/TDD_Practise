from pytest_tennis7.pytest_tennis7 import Tennis


class TestTennisGame(object):
    def setup(self):
        self.tennis = Tennis("Diana", "Diana1")


    def test_second_player_win(self):
        self.given_deuce()
        self.given_second_player_score_times(2)
        self.score_should_be("Diana1 Win")
    ...
    def test_second_player_adv(self):
        ...
        self.score_should_be("Diana1 Adv")
    ...
    def given_first_player_score_times(self, times):
        for i in range(times):
            self.tennis.first_player_score_times()

    def given_second_player_score_times(self, times):
        for i in range(times):
            self.tennis.second_player_score_times()
